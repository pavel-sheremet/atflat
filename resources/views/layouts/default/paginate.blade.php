        ...
        <ul class="pagination justify-content-center">
            ...
            @foreach ($elements as $element)
                ...
                @if (is_string($element))
                    <li class="page-item disabled d-none d-sm-flex" aria-disabled="true"><span class="page-link">{{ $element }}</span></li>
                @endif
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        ...
                        @else
                            <li class="page-item d-none d-sm-flex"><a class="page-link" href="{{ $url }}">{{ $page }}</a></li>
                        @endif
                    @endforeach
                @endif
            @endforeach
