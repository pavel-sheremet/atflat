export default {
    ...
    "ru": {
            ...
            "page": {
                "profile": {
                    ...
                    "show": {
                        "block": {
                            "register": {
                                "description": "Вы пока не являетесь Агентом ни одного Агенства, но можете <a href=\"http://atflat.loc/agent/create\">им стать</a>"
                            }
                        }
                    }
                },
        ...
        "main": {
            "title": "Atflat-Platform - поиск и подбор недвижимости.",
            "description": "Atflat-Platform - открытая платформа поиска и подбора недвижимости.",
            "platform": {
                    ...
                    "index": {
                        ...
                        "block": {
                            "list": {
                                "title": "Мои агенства",
                                "description": {
                                    "exist_agencies": "Здесь вы можете просмотреть список своих агенств, а также <a href=\"http://atflat.loc/agency/create\">создать</a> новые.",
                                    "not_exist_agencies": "У вас пока нет своих агенств, но вы можете <a href=\"http://atflat.loc/agency/create\">создать</a> новые."
                                },
                                "link": {
